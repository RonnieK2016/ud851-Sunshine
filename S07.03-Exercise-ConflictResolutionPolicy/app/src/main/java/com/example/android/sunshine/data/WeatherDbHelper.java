...
//  COMPLETED Increment the database version after changing the create table statement
    /*
...
//              COMPLETED Add a UNIQUE constraint on the date column to replace on conflict
