...
//  COMPLETED Increment the database version after altering the behavior of the table
    /*
...
//              COMPLETED Append NOT NULL to each column's type declaration except for the _ID
                /*
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion, int newVersion) {
        // COMPLETED Within onUpgrade, drop the weather table if it exists
        sqLiteDatabase.execSQL("DROP TABLE IF EXISTS " + WeatherEntry.TABLE_NAME + ";");
        // COMPLETED call onCreate and pass in the SQLiteDatabase (passed in to onUpgrade)
