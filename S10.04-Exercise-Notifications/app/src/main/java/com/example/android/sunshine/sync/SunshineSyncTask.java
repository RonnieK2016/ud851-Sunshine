...
//                  COMPLETED If more than a day have passed and notifications are enabled, notify the user
                    long lastNotificationsTime = SunshinePreferences.getLastNotificationTimeInMillis(context);
                    boolean oneDayPassed = (System.currentTimeMillis() - lastNotificationsTime) > DateUtils.DAY_IN_MILLIS;
